...
export const CATEGORIES = {
  ...
  fines: { label: 'Штрафы', icon: '🚨', color: '#EF4444' },
  other: { label: 'Другое', icon: '📦', color: '#64748B' },
}

// ── Currencies ───────────────────────────────────────────────────
export const CURRENCIES = {
  RUB: { symbol: '₽', code: 'RUB', label: 'Рубль' },
  USD: { symbol: '$', code: 'USD', label: 'Доллар' },
  EUR: { symbol: '€', code: 'EUR', label: 'Евро' },
  GBP: { symbol: '£', code: 'GBP', label: 'Фунт' },
  AED: { symbol: 'AED', code: 'AED', label: 'Дирхам' },
  VND: { symbol: '₫', code: 'VND', label: 'Донг' },
}
...
export const defaultCar = {
  ...
  vin: '', fuelType: 'petrol', drivetrain: '', currency: 'RUB', createdAt: '',
}
